...
let start1 = setInterval(() => {
    ...
    loader1.style.background = `linear-gradient(to right, rgb(180, 180, 180),grey)`;
...
let start2 = setInterval(() => {
    ...
    loader2.style.background = `linear-gradient(to right, rgb(180, 180, 180),grey)`;
...
let start3 = setInterval(() => {
    ...
    loader3.style.background = `linear-gradient(to right, rgb(180, 180, 180),grey)`;
